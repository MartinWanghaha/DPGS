...
class DPGSTrainer:
    ...
    def train_step_gs(self, max_lr = False, no_densify = False):
        ...
        #     min_threshold = self.training_config.scale_min_thresh  # 比如 0.01
        #     max_threshold = self.training_config.scale_max_thresh  # 比如 0.2
        ...
        #     loss += self.training_config.scale_loss_weight * scale_loss
        ...
        #     print(f"max_scale: min={max_scale.min().item():.4f}, max={max_scale.max().item():.4f}, mean={max_scale.mean().item():.4f}, std={max_scale.std().item():.4f}")
            # if self.training_step > 10000 and self.training_step % 50 == 0:
